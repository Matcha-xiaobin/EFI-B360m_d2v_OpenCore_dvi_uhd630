...
OC引导文件
```
> OC引导目前还挺好用的了，不过不爱折腾的建议还是使用Clover引导，目前OC引导更新的有点快，可能每次更新都会有较多改动
> 我是用Clover引导装好了系统，然后才来弄的OC引导
...
# 其他问题   
```
* open core版本:  0.5.3 11/27 <url>https://github.com/williambj1/OpenCore-Factory</url>
* macOS版本:  10.15.1
* 通过DVI或者VGA输出实测都可以
